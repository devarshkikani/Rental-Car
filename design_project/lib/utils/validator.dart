...
//   }
  ...
  static String? validateEmail(String? value) {
    ...
    if (value == null || value.isEmpty) {
      ...
      return "Enter the email Address in this formate someone@example.com";
    } else {
      return null;
    }
  }
  ...
  static String? validateName(String? value, String type) {
    ...
    if (value == null || value.length < 3) {
      return "$type Must be more than 2 characters";
    } else if (!regExp.hasMatch(value)) {
  ...
  static String? validateuserName(String? value, String type) {
    String pattern = r'^[a-zA-Z ]{2,50}$';
    RegExp regExp = RegExp(pattern);
    if (value == null || value.length < 3) {
      return "$type is required";
  ...
  static String? validatePassword(String value) {
    ...
    if (value.isEmpty) {
      ...
      return 'Need to add "At least one number, one special character and one capital letter"';
    } else {
      return null;
    }
  }
