...
class Identification3Page extends StatefulWidget {
  const Identification3Page({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<Identification3Page> createState() => _Identification3PageState();
}

class _Identification3PageState extends State<Identification3Page> {
                          ...
                          Flexible(
                            child: Padding(
                              ...
                              child: Align(
                                ...
                                child: Text(
                                  'A closeup of your face, with your driver\'s licence or Identity Card held next to it',
