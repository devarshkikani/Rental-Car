...
import 'package:design_project/ui/Identification3.dart';
...
class Identification2Page extends StatefulWidget {
  const Identification2Page({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<Identification2Page> createState() => _Identification2PageState();
}

class _Identification2PageState extends State<Identification2Page> {
                          ...
                          Flexible(
                            child: Padding(
                              ...
                              child: Align(
                                ...
                                child: Text(
                                  'A clear image of your Identity Card',
                ...
                child: Container(
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) => Identification3Page(title: "title"),));
                      },
                    ),
                ),
              ),
